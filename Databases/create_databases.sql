...
DROP DATABASE IF EXISTS tracker_claims_dotnet_test;
DROP DATABASE IF EXISTS tracker_claims_dotnet_dev;
...
CREATE DATABASE tracker_claims_dotnet_test;
CREATE DATABASE tracker_claims_dotnet_dev;